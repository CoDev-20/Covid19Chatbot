...
Ethan James Reyes<br>
John Rivera<br>
Rendell Sheen Suliva<br>
Clint Aldrin Valencia<br>
...
* [User Stories (General User)](#user-stories-general-user)
* [User Stories (Administrator)](#user-stories-administrator)
...
* [Sample Snapshots](#sample-snapshots)
  ...
  * [Chatbot Interactions](#chatbot-interactions)
  * [Administrator Homepage](#administrator-homepage)
...
## Sample Snapshots
### Website Homepage
![alt text](https://github.com/CoDev-20/Covid19Chatbot/blob/master/UI/images/1.PNG "Logo Title Text 1")
 
 
### About us page
![About us page](https://github.com/CoDev-20/Covid19Chatbot/blob/master/UI/images/2.PNG "About us page")
...
![Messages Database](https://github.com/CoDev-20/Covid19Chatbot/blob/master/UI/images/10.PNG "Messages Database")
