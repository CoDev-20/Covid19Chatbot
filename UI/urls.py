...
urlpatterns = [
    ...
    path('account/password-change/done/', auth_views.PasswordChangeDoneView.as_view(template_name='UI/pages/changepass-done.html'), 
        name='password_change_done'),
    path('account/password-change/', auth_views.PasswordChangeView.as_view(template_name='UI/pages/changepass.html'), 
